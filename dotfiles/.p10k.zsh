# Generated by Powerlevel10k configuration wizard on 2023-09-19 at 14:12 CDT.
...
# sharp heads, flat tails, 2 lines, dotted, no frame, lightest-ornaments, sparse,
...
() {
  ...
  function prompt_proxy() {
    if (( ${+HTTP_PROXY} )); then
      p10k segment -b 1 -f 3 -t "proxy on"
    fi
  }
